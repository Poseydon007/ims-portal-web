// TE-IMS-REF-SYS-004 Rev00 — ISO 45001:2018 Certificate
...
const ISO_45001_CDN = "https://d2xsxph8kpxj0f.cloudfront.net/310519663473952399/3YVZojsY2rei5QwThHiV6E/iso-45001-cert_2ae7ed9a.jpg";

export default function REF_SYS_004() {
  return (
        ...
        <div className="container flex items-center justify-between py-3 gap-4 flex-wrap">
          <div>
            ...
            <div className="flex items-center gap-3 mt-0.5 flex-wrap">
              <span className="te-code text-xs" style={{ color: "#6b7a8d" }}>TE-IMS-REF-SYS-004_Rev00</span>
        ...
        <aside className="hidden lg:block w-52 shrink-0 sticky top-20 rounded border" style={{ backgroundColor: "#fff", borderColor: "#dde3ec" }}>
          <div className="p-4 border-b" style={{ borderColor: "#dde3ec" }}>
            ...
            <dl className="space-y-2">
              {[
                ["Document Code", "TE-IMS-REF-SYS-004"],
                ["Revision", "Rev 00"],
          ...
          <div className="rounded border bg-white overflow-hidden" style={{ borderColor: "#dde3ec" }}>
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b" style={{ borderColor: "#dde3ec", backgroundColor: "#fafbfc" }}>
              ...
              <div className="text-right">
                <div className="te-code text-xs" style={{ color: "#8a9ab0" }}>TE-IMS-REF-SYS-004_Rev00</div>
              </div>
            </div>
            ...
            <div className="px-8 py-6">
              ...
              <div className="rounded px-5 py-4 mb-6" style={{ backgroundColor: "#081C2E" }}>
                <h1 className="text-white text-xl font-extrabold tracking-wide text-center uppercase">
                  ISO 45001:2018 — Occupational Health &amp; Safety Management System Certificate
                </h1>
              </div>
              ...
              <table id="details" className="w-full text-xs border-collapse mb-6" style={{ borderColor: "#dde3ec" }}>
                <tbody>
                  <tr>
                    ...
                    <td className="border px-3 py-2" style={{ borderColor: "#dde3ec" }}>ISO 45001:2018</td>
                    <td className="border px-3 py-2 font-semibold w-1/4" style={{ borderColor: "#dde3ec", backgroundColor: "#f4f6f9" }}>System</td>
                    <td className="border px-3 py-2" style={{ borderColor: "#dde3ec" }}>Occupational Health &amp; Safety Management System</td>
                  </tr>
                  <tr>
                    <td className="border px-3 py-2 font-semibold" style={{ borderColor: "#dde3ec", backgroundColor: "#f4f6f9" }}>Certificate No.</td>
                    <td className="border px-3 py-2 te-code" style={{ borderColor: "#dde3ec" }}>CN-OH&amp;SMS-15251160</td>
