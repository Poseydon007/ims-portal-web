// TE-IMS-REF-SYS-004 — ISO 45001:2018 Certificate
      ...
      <div style={{ backgroundColor: "#081C2E" }} className="py-6">
        <div className="container">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-white/50 text-xs">TE-IMS-REF-SYS-004</span>
          </div>
      ...
      <div className="container pb-12">
        ...
        >
          <div>
            ...
            <div className="font-bold" style={{ color: "#081C2E" }}>ISO 45001:2018</div>
          </div>
          <div>
            <div className="text-xs font-semibold uppercase tracking-widest mb-1" style={{ color: "#8a9ab0" }}>System</div>
            <div className="font-bold" style={{ color: "#081C2E" }}>Occupational Health &amp; Safety Management System</div>
          </div>
          <div>
            <div className="text-xs font-semibold uppercase tracking-widest mb-1" style={{ color: "#8a9ab0" }}>Certificate No.</div>
            <div className="font-bold" style={{ color: "#081C2E" }}>CN-OH&amp;SMS-15251160</div>
          </div>
          <div>
