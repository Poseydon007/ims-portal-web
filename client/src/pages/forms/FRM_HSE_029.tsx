    ...
    <Layout>
      <div className="max-w-2xl mx-auto py-16 px-6 text-center">
        <div className="inline-block bg-yellow-50 border border-yellow-200 rounded-lg p-8">
          ...
          <h1 className="text-xl font-bold text-[#081C2E] mb-2">PPE Weekly Inspection Checklist</h1>
          <p className="text-sm text-gray-500 mb-1 font-mono">TE-IMS-FRM-HSE-029</p>
