...
export const documentsByCategory: Record<string, ImsDocument[]> = {
  ...
  reg: [
    { code: "TE-IMS-REG-GOV-001", title: "IMS Objectives & Targets Register", rev: "Rev00", date: "—", status: "pending", slug: "TE-IMS-REG-GOV-001", available: false, driveUrl: "https://drive.google.com/open?id=1FhwiV6EwqCtN6F94pTXMLP6n7Pf3lojj" },
    ...
    { code: "TE-IMS-REG-HSE-002", title: "PPE Issue & Inspection Register", rev: "Rev00", date: "—", status: "pending", slug: "TE-IMS-REG-HSE-002", available: false, driveUrl: "https://drive.google.com/open?id=1Cf-ZJfNiJIJFtqtc9XuqVKZi-BWdqNsF" },
    { code: "TE-IMS-REG-HSE-003", title: "Emergency Contacts Directory", rev: "Rev01", date: "—", status: "pending", slug: "TE-IMS-REG-HSE-003", available: false, driveUrl: "https://drive.google.com/open?id=1EilKj-U61_Eedn4YLnPqEGLyplc_LE4P" },
    ...
    { code: "TE-IMS-REG-SYS-002", title: "KPI Dashboard & Performance Log", rev: "Rev00", date: "—", status: "pending", slug: "TE-IMS-REG-SYS-002", available: false, driveUrl: "https://drive.google.com/open?id=12oXdknwUVEoOg3noZShv0sza5ByFqUE-" },
    { code: "TE-IMS-REG-SYS-003", title: "Legal & Regulatory Compliance Register", rev: "Rev00", date: "—", status: "pending", slug: "TE-IMS-REG-SYS-003", available: false, driveUrl: "https://drive.google.com/open?id=1_QJQJAfp2sNDH-UDHztxhmHXFOqqJ_6V" },
