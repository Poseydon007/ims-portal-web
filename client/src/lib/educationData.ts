    ...
    resources: [
      {
        ...
        type: "video",
        available: true,
        url: "https://1drv.ms/v/c/3fc547dccdd2997a/IQBttkOVfZwnSa8dWvTMql63AdJg0bCEYKnTWsYfn30uni0?e=gxCdOO",
        thumbnailUrl: "/thumbnails/siteinduction-thumb.png",
        duration: "20 min",
      ...
      },
      {
        ...
        description: "How the permit to work system operates, who can issue permits, and what activities require them. Covers all five permit types, the full PTW lifecycle, roles and responsibilities, hot work, confined space entry, and LOTO.",
        type: "manual",
        available: true,
        url: "/PTWManual.html",
        tags: ["permit", "PTW", "operations", "LOTO", "confined space", "hot work"],
      },
    ],
  },
  {
    ...
    resources: [
      {
        ...
        description: "Daily pre-start checklist and inspection procedure for mobile plant and heavy equipment. Covers the WAFT sequence, 12-point walk-around, the Red Tag system, common defects and what they mean, and operator legal responsibilities.",
        type: "checklist",
        available: true,
        url: "/PreStartInspectionChecklist.html",
        tags: ["inspection", "equipment", "pre-start", "red tag", "WAFT"],
      },
    ],
  },
  {
    ...
    resources: [
      {
        ...
        description: "Key obligations under the Saudi Mining Investment Law (Royal Decree M/40) and Vision 2030 mining framework. Covers licence types, environmental obligations, worker rights, incident reporting requirements, and common compliance gaps.",
        type: "guide",
        available: true,
        url: "/KSAMiningLaw.html",
        tags: ["KSA", "mining law", "compliance", "MIMR", "MISA", "Vision 2030"],
      },
      {
        id: "reg-002",
        title: "MHRSD OHS Regulations Overview",
        description: "Occupational health and safety obligations under MHRSD regulations for mining operations. Covers key Labour Law articles, employer obligations, worker rights, contractor rules, and what to expect during an MHRSD inspection.",
        type: "guide",
        available: true,
        url: "/MHRSDRegulations.html",
        tags: ["MHRSD", "OHS", "regulations", "Labour Law", "Article 121"],
      },
    ],
  },
];
